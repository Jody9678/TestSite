...
Github Repo: [Reproducible Research](https://github.com/Jody9678/RepData_PeerAssessment2/tree/master/Reproducible_Research)
</br>

## 1: Synopsis
The goal of the report is to highlight the impact of severe weather events on both population and economy, using the NOAA Storm Database as reference. The database covers the time period between 1950 and November 2011.
...
download.file(fileUrl, destfile = paste0("~/Users/smith/Desktop", '/repdata%2Fdata%2FStormData.csv.bz2'))
stormDF <- read.csv("~/Users/smith/Desktop/repdata%2Fdata%2FStormData.csv.bz2")
